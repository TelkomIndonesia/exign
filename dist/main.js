...
async function startServers() {
    ...
    const app = (0, app_1.newApp)({ ...cfg, logDB });
    ...
    const srv5 = http_1.default.createServer((0, mgmt_app_1.newMgmtApp)({ ...cfg, logDB }))
...
async function init() {
    await (0, config_1.generatePKIs)();
    const cfg = (0, config_1.newAppConfig)();
    const logDB = new log_1.LogDB(cfg.logdb);
    const mgmtServer = http_1.default.createServer((0, mgmt_app_1.newMgmtApp)({ ...cfg, logDB }))
        .listen(3000, () => console.log('[INFO] HTTP Management Server running on port 3000'));
    await (0, config_1.downloadRemoteConfigs)();
    await (0, config_1.commitConfig)();
    logDB.close();
    mgmtServer.close();
}
