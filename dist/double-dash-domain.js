...
async function mapDoubleDashHostnameDNS(hostname) {
    ...
    let txt;
    try {
        txt = await (0, promises_1.resolveTxt)(hostname);
    }
    catch (err) {
        return '';
    }
...
async function mapDoubleDashHostname(hostname, doubledashdomain) {
